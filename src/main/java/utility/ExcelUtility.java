...
public class ExcelUtility {
    ...
    public Iterator<Object[]> getApiTestData(Method method) throws IOException {
        return excelAPIDataReader("./src/test/resources/APIDetailsSheet.xlsx",method.getName());
    }
     ...
     * @throws IOException
     **/
    public static final Iterator<Object[]> excelAPIDataReader(String filepath,String testCaseName) throws IOException {
